...
namespace bpmalmacen
{
    public partial class entrada : Form
    {
        ...
        // string iplocal = "10.18.2.19";
         ...
         MySqlDataReader reader3 = obj3.Estructura("SELECT nombre,clave2,dato1,dato2,dato3 FROM configuracion ;");
             string nombre;
             string serial = "";
             string serial1 = "" ;
             string serial2 = "";
        ...
        while (reader3.Read())
         {
             nombre = reader3[0].ToString().ToUpper();
             serial = reader3[1].ToString();
             serial1 = reader3[2].ToString().ToUpper();
        ...
        serial = modulo1.Desencriptar(serial);
         ...
         if (pcmerida == "si" | pclocal == "si")
         {
             ...
             MySqlDataReader reader6 = obj.Estructura("SELECT nombre, numero, usuarioip FROM usuarios where usuarioip = '" +localIP+"';");
             while (reader6.Read())
             {
                 string nmbreusuario = reader6[0].ToString().ToUpper();
             ...
             try
             {
                 ...
                 dbcom obj2 = new dbcom();
                 mostrarfoto = "no";
                 this.dataGridView1.DataSource = obj2.sql("SELECT nombre as 'Nombre', numero as 'Numero' FROM usuarios;");
