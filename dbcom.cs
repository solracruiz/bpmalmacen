    ...
    class dbcom
    {
        ...
        private MySqlConnection conect()
        {
            ...
            try
            {
                ...
                {
                    conn.ConnectionString = "Server=192.168.157.24; Database=almacen; Uid=root;PWD=c1r7g4s;Port=3306;Pooling=false;Connection Lifetime=1; Max Pool Size=1;";

                }
                if (entrada.pclocal == "si")
                {
                    conn.ConnectionString = "Server=localhost; Database=bpmalmacen; Uid=root;;PWD=c1r7g4s;Pooling=false;Connection Lifetime=1; Max Pool Size=1;";
